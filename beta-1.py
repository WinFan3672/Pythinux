try:
    ...
    def logged():
        ...
        if osk == "about":
            ...
            print()
            print("Python Linux is a 'Linux' distro that uses a")
            ...
            print("[2] Revamping help and CLI")
            ...
            print(osk,"is not a valid command, user, manual or directory.")
            print("For a list of commands type help")
