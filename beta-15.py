...
def man(manual, return_mode=0):
    ...
    if manual == "man":
        ...
        div()
        print(
            "changes deprecated man / removed_man vim echo scripting todo mem updates template szips future_features stdlib alias startup consent roadmap files2 pkm"
        )
        div()
    elif manual == "consent":
        div()
        print(
            "Consent mode is a Scripting feature that allows for elevated functions in a script."
        )
        print("It allows for:")
        ...
        print(
            f"If you reate a file called .startup in the same directory as your {os_name} folder, the contents of it will be run by {os_name}, like a script run on startup. Unlike a script, you can run ./ scripts."
        )
...
def main(ch=""):
    ...
    if ch == "help":
        ...
        print(
            f"{os_name} is distributed under the MIT license, a flexible license that gives you\nfull control over the source code and no warranty."
        )
        div()
        ...
        return preferences["pref_version"]
    elif ch == "stime":
        print("stime [str]")
