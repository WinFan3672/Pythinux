...
try:
    ...
    def man(manual):
        if manual == "/":
            ...
            print()
            print("updates $ man todo / sudo manlist mem changes")
            godcheck()
        elif manual == "changes":
            print("\nBETA 3 changes:")
            print("[1] added MEM command")
            print("Type man mem for more info\n")
            print("[2] Bytegen has the ability to convert bytegen.txt into a vimx file\n")
            print("[3] A lot of math commands now support float numbers")
            print("These include mul and div\n")
            print("[4] Added more things to man todo\n")
            print("[5] Added 1 program")
            print()
    ...
    def logged():
        ...
        if osk == "about":
            ...
            print("relevation godefector godforcemode injector subs gradeaundera showhiddenmanuals/shm")
            print("Every program name is split by a space.")
            print("Programs with a / have an alias[es], meaning that eee/everythingever is the same command but 2 names, each name split by a /")
            print("To run a program, type run <program>")
            godcheck()
        elif osk == "run showhiddenmanuals" or osk == "run shm":
            print("\n%mem% %files% %files_l% %env_var% %vim%")
            print("Show Hidden Manuals V1.00")
            print("Accurate as of Beta 3")
            print()
            print("Press ENTER to continue.")
            wer=input()
            print()
