...
see me in 10 years lol
    ...
    def man(manual):
        if manual == "/":
            ...
            print("\nBETA 4 changes:")
            print("[1] Added Files Program [see files manual]")
            print("[2] Added 2 manuals [files and vim]")
            print("[3] Added Scriptux [see man scriptux]")
            print()
            print("Press ENTER to continue.")
            wer=input()
            print()
            ...
            print("Scriptux is a scripting language used by Pythinux")
    ...
    def logged():
        ...
        if osk == "about":
            ...
            print("circumference, tens, files, scriptux")
            godcheck()
        elif osk =="randint":
            from random import randint
            num1=int(input("Int $"))
