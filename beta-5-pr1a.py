...
see me in 10 years lol
    '''
    '''
    oh btw i made beta 5 on my phone
    '''
    global crashloop
    global crashloop_r
    crashloop=0
    ...
    def man(manual):
        ...
        if manual == "/":
        	...
        	print("Autologin is a variable located at the top of the Pythinux source code")
        	...
        	print("[4] Once you're done, open Pythinux")
        	...
        	print("Once you're done, the ZIP file can be used in Pythinux")
        	wer=input("\nPress ENTER to continue.")
        	godcheck()
        elif manual == "updates":
    ...
    def logged():
        ...
        if osk == "about":
            ...
            print(", , , , , , , , ,")
            print(", , , , ")
            print(", , timeloop, vim, pytho, sqrt, , , ")
            print("reset, run, , , , , , , area,")
            print("circumference, , files, scriptux")
            godcheck()
        elif osk =="randint":
            from random import randint
            num1=int(input("Int $"))
