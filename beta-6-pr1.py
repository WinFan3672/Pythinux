...
##    sleep(1.5)
    ...
    def man(manual):
        ...
        if manual == "/":
            ...
            print("There are some parameters you can type to replace text in echo now:")
            print("%pi --> [pi]")
            print("%pwd --> current directory")
            print("%osinfo -->",os,version)
            print("%date --> date")
            print("%time --> time")
            print("%ctime --> ctime()")
            print("%mem --> mem")
            print("%bmem --> Backup Mem")
            print("\nExample:")
            print("root@root $echo %pi")
            ...
            print("\n"+version, "changes:")
            print("[x] Added support for Pythinux Standard Library [man stdlib]")
            print("[2] Updated bytegen")
            print("[x] Added pythinux_fs command")
            print("[4] MORE MANUALS!")
            print("[5] Immproved echo some more [man echo]")
            print("[6] Added div()")
            div()
            print("For more info, go to <man plan>")
            div()
            print("Press ENTER to continue.")
            wer=input()
            print()
            ...
            div()
            print("For example:")
            print("echo Hello World > test.vimx")
            print("This will write \"Hello World\" to the file `test.vimx`")
            print()
            print("Press ENTER to continue.")
            wer=input()
            print()
    ...
    def logged():
        ...
        if osk == "about":
            ...
            import os as oo #to prevent clashing with os variable
            print(oo.getcwd())
            godcheck()
        elif osk == "sysinfo":
            import platform
            ...
            import math, time
            import os as oo
            echo=echo.replace("%pi",str(math.pi))
            echo=echo.replace("%pwd",str(oo.getcwd()))
            echo=echo.replace("%date",str(time.strftime("%x")))
            echo=echo.replace("%time",str(time.strftime("%X")))
            echo=echo.replace("%ctime",str(time.ctime()))
            echo=echo.replace("%mem",str(mem))
            echo=echo.replace("%bmem",str(bmem))
            temp=os+" "+version
            echo=echo.replace("%osinfo",temp)
            if ">" in echo:
                thing=echo.split("> ")
                f=open(thing[1],"w")
                f.write(thing[0])
