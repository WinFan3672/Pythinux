...
os_name,app_version,="Pythinux",[0,6,"PR10"]
autologin = 1
def vim_editor(fn=""):
    if fn == "":
...
def man(manual):
    if manual == "man":
        ...
        print("DEPRECATED")
        div()
        print("bytegen scriptux files_legacy ping ")
        div()
        print("REMOVED")
        div()
        print("vim_legacy tens")
        div()
        ...
        print("MANUAL LIST")
        div()
        print("changes deprecated man / rewrite vim echo scripting todo")
        br()
        main()
    elif manual == "vim":
        ...
        print("[-] CLS now works!")
        print("[-] Scripting system [man scripting]")
        div()
        ...
        div()
        print("[-] Create a new .XX file [use files to convert a file to an xx file]")
        ...
        div()
        print("To run a script, type ./[script name]. Replace [script name] with the file name of the XX file.")
        div()
...
def main(ch=""):
    ...
    if ch == "help":
        ...
        print(f"scriptux admin_panel files_legacy man userlist_c vim run cat")
        div()
        if return_mode == 0:
            main()
        else:
