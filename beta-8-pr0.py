...
os_name,app_version,="Pythinux",[0,8,"PR0"]
autologin = 1
...
def man(manual, return_mode = 0):
    if manual == "man":
        ...
        print("[-] Added CMD -E [man cmde]")
        print("[-] Added TERMINAL")
        print("[-] Added IDLE-LAUNCH")
        print("[-] Added BUILD-PROG [man szips]")
        print("[-] Added TEMPLATE [man template]")
        br()
        if return_mode == 0:
            main()
        else:
...
def main(ch=""):
    ...
    if ch == "help":
        ...
        main()
    elif "jit " in ch and return_mode == 0:
        main(ch[4:])
        main()
    else:
        if return_mode == 0:
