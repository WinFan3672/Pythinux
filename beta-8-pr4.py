...
def man(manual, return_mode = 0):
    if manual == "man":
        ...
        print("MANUAL LIST")
        div()
        print("changes deprecated man / rewrite vim echo scripting todo mem updates template szips future_features stdlib alias")
        div()
        if return_mode == 0:
            main()
        else:
...
def main(ch=""):
    ...
    if ch == "help":
        ...
        print(f"idle-launch jit install stdlib alias add_alias")
        div()
        if return_mode == 0:
            main()
        else:
