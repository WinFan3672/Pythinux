...
os_name,app_version,="Pythinux",[0,8,0]
autologin = 1
...
def man(manual, return_mode = 0):
    if manual == "man":
        ...
        print("MANUAL LIST")
        div()
        print("changes eprecated man / removed_man vim echo scripting todo mem updates template szips future_features stdlib alias startup")
        div()
        if return_mode == 0:
            main()
        else:
        ...
        print("[-] Added Standard Library support [MAN STDLIB]")
        print("[-] Added alias support [MAN ALIAS]")
        print("[-] Added INSTALL command")
        print("[-] When creating a user using add_user, the password is now stored as an SHA256 hash.")
        print("[-] Startup Script Support [MAN STARTUP]")
        print("[-] User Control program")
        print("   [-] Root users can use this program")
        print("   [-] Allows for controlling certain things, such as autologin and user permissions")
        br()
        if return_mode == 0:
            main()
        else:
        ...
        print("If you create a file called .startup in the same directory as your {os_name} folder, the contents of it will be run by Pythinux, like a script run on startup. Unlike a script, you can run ./ scripts.")
    else:
        return True
...
def user_control():
    ...
    print("[x] User List")
    print("[x] User Remove")
    print("[x] User Edit User")
    print("[4] Refersh Userlist Data")
    ...
    if ch == 4:
        ...
        try:
            ...
            print("Note: When you need to enter your password, enter `root`. This is a result of the password being stored as a hash. This will be fixed soon.")
        except:
            div()
            print("Failed to complete action.")
        user_control()
