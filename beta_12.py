...
def user_editor_v2():
    ...
    if ch == "help":
        ...
        print("clear - deletes all users [dangerous!]")
...
def main(ch="",allow_script=0,return_mode=-1):
    ...
    if ch == "help":
        ...
        print("var mem ihelp prompt wget echf linuxhub user_editor ucode qaa installd force-quit")
        div()
        if return_mode == 0:
            main()
        else:
        ...
        print("Notes")
        div()
        print("[-] Due to a bug, you can only run a program once. After that, you need to reboot the OS to run it again.")
