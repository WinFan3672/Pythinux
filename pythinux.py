...
os_name,app_version,="Pythinux",[0,13,0]
autologin = 0
import os
...
def man(manual, return_mode = 0):
    ...
    if manual == "man":
        ...
        div()
        print("[-] PKM 1.0 --> 1.1")
        print("[-] Added QAAG command")
        print("[-] Run command now logs errors")
        print("[-] Added more manuals")
        print("[-] Added login command")
        print("[-] Updated `started` command")
        print("[-] Updated `ihelp` command")
        print("[-] Updated INSTALLD to v1.1")
        print("   [-] `setup.py` works now")
        print("[-] Updated Files to 2.2")
        print("   [-] Now has copy/paste commands")
        br()
        if return_mode == 0:
            main()
        else:
